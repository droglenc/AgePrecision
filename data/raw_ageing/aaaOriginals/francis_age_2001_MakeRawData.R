...
rs <- data.frame(vertebrae_R1=rep(r1rs,frrs),vertebrae_R2=rep(r2rs,frrs),species="Rough Skate")
...
ss <- data.frame(vertebrae_R1=rep(r1ss,frss),vertebrae_R2=rep(r2ss,frss),species="Smooth Skate")
df <- rbind(rs,ss)
